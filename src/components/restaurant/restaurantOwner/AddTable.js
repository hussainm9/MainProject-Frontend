...
import { Card, CardBody } from "reactstrap"; // Import Reactstrap components
        ...
        <div className="container">
            <div className="row">
                <div className="col-md-6 offset-md-3">
                    <Card> {/* Wrap the content in Card component */}
                        <CardBody> {/* Wrap the content in CardBody component */}
